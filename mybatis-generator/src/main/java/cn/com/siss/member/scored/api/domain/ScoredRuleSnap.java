...
public class ScoredRuleSnap implements Serializable {
    /**
     * 积分规则快照ID
     * 表字段 : scored_rule_snap.id
     */
    private Long id;

    /**
     * 积分规则ID
     * 表字段 : scored_rule_snap.rule_id
     */
    private Long ruleId;

    /**
     * 商户编号
     * 表字段 : scored_rule_snap.merchant_id
     */
    private Long merchantId;

    /**
     * 会员类别(等级)ID
     * 表字段 : scored_rule_snap.level_id
     */
    private Long levelId;

    /**
     * 会员类别(等级)编号
     * 表字段 : scored_rule_snap.level_no
     */
    private String levelNo;

    /**
     * 注册赠送积分(0:不赠送)
     * 表字段 : scored_rule_snap.register_scored
     */
    private BigDecimal registerScored;

    /**
     * 积分获取方案(1:不启用; 2:按消费比例; 3:按商品给定积分值; 4:按商品类别; 5按商品品牌)
     * 表字段 : scored_rule_snap.scored_plan
     */
    private Integer scoredPlan;

    /**
     * 积分方案的消费金额(单位:分)
     * 表字段 : scored_rule_snap.scored_plan_amount
     */
    private Integer scoredPlanAmount;

    /**
     * 积分方案的积分值
     * 表字段 : scored_rule_snap.scored_plan_value
     */
