...
public class ScoredOrder implements Serializable {
    /**
     * 订单ID
     * 表字段 : scored_order.id
     */
    ...
    /**
     * 商户编号
     * 表字段 : scored_order.merchant_id
     */
    private Long merchantId;

    /**
     * 会员ID
     * 表字段 : scored_order.member_id
     */
    private Long memberId;

    /**
     * 会员卡(编)号[积分账号]
     * 表字段 : scored_order.member_no
     */
    private String memberNo;

    /**
     * 会员类别(等级)ID
     * 表字段 : scored_order.level_id
     */
    private Long levelId;

    /**
     * 积分账户ID
     * 表字段 : scored_order.account_id
     */
    private Long accountId;

    /**
     * 储值规则ID
     * 表字段 : scored_order.rule_id
     */
    private Long ruleId;

    /**
     * 储值规则快照ID
     * 表字段 : scored_order.rule_snap_id
     */
    private Long ruleSnapId;

    /**
     * 业务门店ID[会员自己(定时任务)操作的,值为会员的所属门店]
     * 表字段 : scored_order.branch_id
     */
    private Long branchId;

    /**
     * 业务门店编号(同branch_id)
     * 表字段 : scored_order.branch_no
     */
    private String branchNo;

    /**
     * 业务门店名称
     * 表字段 : scored_order.branch_name
     */
    private String branchName;

    /**
     * 业务(操作)订单号
     * 表字段 : scored_order.operate_order_no
     */
    private String operateOrderNo;

    /**
     * 业务(操作)类型(1:增加积分; 2:抵扣积分; 3:转储兑换; 4:产品兑换; 99:过期)
     * 表字段 : scored_order.operate_type
     */
    private Integer operateType;

    /**
     * 业务(操作)积分
     * 表字段 : scored_order.scored
     */
    private BigDecimal scored;

    /**
     * 业务(操作)金额(单位:分)(冗余记录字段)
     * 表字段 : scored_order.amount
     */
    private Integer amount;

    /**
     * 业务(操作)员ID
     * 表字段 : scored_order.operate_id
     */
    private String operateId;

    /**
     * 业务操作时间
     * 表字段 : scored_order.operate_time
     */
    private Date operateTime;

    /**
     * 业务说明
     * 表字段 : scored_order.description
     */
    private String description;

    /**
     * 状态(1:未确认; 2:已确认; 3:已撤销)
     * 表字段 : scored_order.status
     */
    private Integer status;

    /**
     * 创建时间
     * 表字段 : scored_order.created_time
     */
    private Date createdTime;

    /**
     * 创建人
     * 表字段 : scored_order.created_by
     */
    private String createdBy;

    /**
     * 更新时间
     * 表字段 : scored_order.updated_time
     */
    private Date updatedTime;

    /**
     * 更新人
     * 表字段 : scored_order.updated_by
     */
    private String updatedBy;

    /**
     * 备注
     * 表字段 : scored_order.remark
     */
    private String remark;

    /**
     * 删除标识(1:在线; 2:删除)
     * 表字段 : scored_order.deleted
     */
    private Integer deleted;

    private static final long serialVersionUID = 1L;

    public ScoredOrder(Long id, Long merchantId, Long memberId, String memberNo, Long levelId, Long accountId, Long ruleId, Long ruleSnapId, Long branchId, String branchNo, String branchName, String operateOrderNo, Integer operateType, BigDecimal scored, Integer amount, String operateId, Date operateTime, String description, Integer status, Date createdTime, String createdBy, Date updatedTime, String updatedBy, String remark, Integer deleted) {
        this.id = id;
